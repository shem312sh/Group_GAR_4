...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Nov 27, 2021 at 10:49 PM
...
INSERT INTO `reservation` (`ReservationID`, `TimeID`, `UserID`) VALUES
(5, 1, 1);
...
CREATE TABLE IF NOT EXISTS `servicetime` (
  `TimeID` int(11) NOT NULL AUTO_INCREMENT,
  `CSID` int(11) NOT NULL,
  `ServiceDate` date NOT NULL,
  `TimeFrom` varchar(800) NOT NULL,
  `TimeTo` varchar(800) NOT NULL,
  PRIMARY KEY (`TimeID`),
  KEY `CSID` (`CSID`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
...
INSERT INTO `servicetime` (`TimeID`, `CSID`, `ServiceDate`, `TimeFrom`, `TimeTo`) VALUES
(1, 1, '2021-12-01', '09:00', '10:00'),
(2, 1, '2021-12-01', '10:00', '11:00'),
(3, 1, '2021-12-01', '11:00', '12:00'),
(4, 1, '2021-12-02', '08:00', '09:00');
...
ALTER TABLE `reservation`
  ...
  ADD CONSTRAINT `reservation_ibfk_3` FOREIGN KEY (`TimeID`) REFERENCES `servicetime` (`TimeID`);

--
-- Constraints for table `servicetime`
--
ALTER TABLE `servicetime`
  ADD CONSTRAINT `servicetime_ibfk_1` FOREIGN KEY (`CSID`) REFERENCES `centerservices` (`CSID`);
COMMIT;
